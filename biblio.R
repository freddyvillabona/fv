...
ggplot() +
  ...
  geom_textbox(
    ...
    mapping = aes(
      x = 7.5, y = 3.5,
      label = "Cada libro representa un año, con los años 2000 en el estante inferior y los años 2020 en el estante superior."
    ),
    fill = "transparent",
  ...
  geom_textbox(
    ...
    mapping = aes(
      x = 7.5, y = 2.5,
      label = "La altura de los libros representa la financiación total recibida por la Biblioteca Británica (ajustada al año 2000)."
    ),
    fill = "transparent",
    box.colour = "transparent",
    colour = "#F8F9F1",
  ...
  geom_textbox(
    ...
    mapping = aes(
      x = 3, y = 1.6,
      label = "El color de los libros representa si el porcentaje de financiación que procede del Gobierno británico es (financiación básica). <span style='color:#1b7837;'>**higher**</span> or <span style='color:#762a83; background: coral;'>**lower**</span> en comparación con el año 2000."
    ),
    fill = "transparent",
    box.colour = "transparent",
    colour = "#F8F9F1",
